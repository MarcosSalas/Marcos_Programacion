...
public class ControllerBD_Borja {
        ...
        public void insertarAlumnoStatement(Alumno alumno) {
            ...
            try {
                ...
                String queryFormat = String.format(/*todo*/"INSERT INTO %s (%s, %s, %s) VALUES ('%s','%s',%d)",SchemeDB.TAB_ALU,
                        SchemeDB.COL_NOMBRE,SchemeDB.COL_APELLIDO,SchemeDB.COL_EDAD,
        ...
        public void insertarAlumnoPrepare(){
            ...
            String apellido = "Martin";
            int  edad = 38;
            String query  =  /*todo*/ "INSERT INTO alumnos (nombre, apellido, edad) VALUES (?,?,?)";
            try {
                // no ejecuta la query --> la deja preparada
                getConnection();
                preparedStatement = conn.prepareStatement(query);
                preparedStatement.setString(1,nombre);/*con el setString formateo en el prepare */
