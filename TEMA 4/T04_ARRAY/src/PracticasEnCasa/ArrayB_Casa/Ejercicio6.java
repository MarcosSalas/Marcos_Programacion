...
public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("El contador 6 tiene %d cambios %n", cont6);
        System.out.printf("El contador 7 tiene %d cambios %n", cont7);
        System.out.printf("El contador 20 tiene %d cambios %n", cont20);
    }
}
