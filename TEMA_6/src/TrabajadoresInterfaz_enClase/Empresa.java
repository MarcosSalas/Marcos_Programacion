...
public class Empresa {                         // TODOS LOS MÉTODOS ADD, LISTAR ETC
    ...
    public void addPersona(Persona persona){// aderimos un objeto de tipo persona
        //restriccion DNI FALTA COMPLETAR COMO EN EL EXAMEN   //LO TIENE LA CLASE BIBLIOTECA DEL EJERCICIO 6
        personas.add(persona);
    }
    public void  despedirPersona(String dni){  // BORRAR PERSONA
